...
public class CreatePdfWithText
{
     ...
     */
    public PDDocument doIt( String file, String message) throws IOException, COSVisitorException
    {
        // the document
        PDDocument doc = null;
        try
    ...
    {
        CreatePdfWithText app = new CreatePdfWithText();
        try
        {
            if( args.length != 2 )
            {
