...
public class CreateVisibleSignature implements SignatureInterface
{
    ...
    public CreateVisibleSignature(String keyfile, String password)
    {
    ...
    public File signPDF(File document, PDVisibleSigProperties signatureProperties) throws IOException,
            COSVisitorException, SignatureException, org.apache.pdfbox.exceptions.SignatureException {
        ...
        File outputDocument = new File(document.getParent(), substring + "_signed_visible.pdf");
    ...
    public static void main(String[] args) throws KeyStoreException, NoSuchAlgorithmException, CertificateException,
            FileNotFoundException, IOException, COSVisitorException, SignatureException, org.apache.pdfbox.exceptions.SignatureException {
